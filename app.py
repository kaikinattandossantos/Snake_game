...
class Snake:
    def __init__(self):
        ...
        for i in range(0, BODY_PARTS):
            self.coordinates.append([0, 0])  # A cobra começa no canto superior esquerdo
...
canvas = Canvas(window, bg=BACKGROUND_COLOR, height=GAME_HEIGHT, width=GAME_WIDTH)  # Corrigido width
canvas.pack()
